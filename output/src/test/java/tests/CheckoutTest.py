...
class CheckoutTest(BaseTest):
    ...
    def test_verify_clicking_checkout_loads_checkout_page(self):
        ...
        assert page.is_checkout_page_loaded()
    ...
    def test_enter_personal_details(self):
        ...
        try:
            assert page.is_continue_button_enabled()
            self.logger.pass("Continue button is enabled, all data are correct")
